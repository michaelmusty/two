...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4)# Stage 2: compute J[2] = H_1(X, F_2) as an F_2[G]-module for a Galois 2-group
...
def solvable_report(genus, dim, Ms, label):
    ...
    GL = libgap.GL(dim, _sage_const_2 )
    ...
    if not solvC:
        ...
        names = [str(libgap.StructureDescription(f)) for f in cf if int(libgap.Order(f)) > _sage_const_1 ]
