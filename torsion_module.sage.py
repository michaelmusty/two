...
_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4)# Stage 2: compute J[2] = H_1(X, F_2) as an F_2[G]-module for a Galois 2-group
...
if __name__ == "__main__":
    import sys
    args = [int(x) for x in sys.argv[_sage_const_1 :]]
    if args:
        scan(args)
    else:
        G = libgap.SmallGroup(_sage_const_8 ,_sage_const_4 )
        gens = libgap.GeneratorsOfGroup(G)
        genus, dim, Ms = analyze(G, gens[_sage_const_0 ], gens[_sage_const_1 ])
