...
# This file was *autogenerated* from the file belyi/reconstruct.sage
from sage.all_cmdline import *   # import sage library

_sage_const_1 = Integer(1); _sage_const_2 = Integer(2); _sage_const_0 = Integer(0); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4); _sage_const_13 = Integer(13); _sage_const_5 = Integer(5)# Milestone 3.4 (genus-0-intermediate tower): reconstruct a 2-group Belyi curve from
...
def reconstruct(G, s0, s1, p, verbose=True):
    ...
    chain = chief_series_indices(G); sinf = (s0 * s1)**(-_sage_const_1 )
    for i in range(len(chain) - _sage_const_1 ):
        ...
        if m == _sage_const_1 :
            a = roots[_sage_const_0 ]; s_new = Fw(w**_sage_const_2  + a)
        elif m == _sage_const_2 :
            a, b = roots; s_new = (a * w**_sage_const_2  - b) / (w**_sage_const_2  - _sage_const_1 )
        else:
...
if __name__ == "__main__":
    ...
    f = reconstruct(G, gens[_sage_const_0 ], gens[_sage_const_1 ], _sage_const_13 )
